 ...
 */
class getCenterRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CenterRepository' shared autowired service.
     *
     * @return \App\Repository\CenterRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CenterRepository.php';

        return $container->privates['App\\Repository\\CenterRepository'] = new \App\Repository\CenterRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
