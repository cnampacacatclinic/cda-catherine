 ...
 */
class getPhoneTypeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PhoneTypeRepository' shared autowired service.
     *
     * @return \App\Repository\PhoneTypeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PhoneTypeRepository.php';

        return $container->privates['App\\Repository\\PhoneTypeRepository'] = new \App\Repository\PhoneTypeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
