...
class __TwigTemplate_e790fd1897a8070cd0fe61b3155f4ef381f2f7a6cda9f337b87379e11d12db6d extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 2, $this->source); })()), "flashes", ["success"], "method", false, false, false, 2));
        foreach ($context['_seq'] as $context["_key"] => $context["message"]) {
            // line 3
            echo "        <div class=\"alert success\" role=\"success\">";
...
";
    ...
    {
        return array (  67 => 8,  63 => 7,  59 => 5,  50 => 3,  46 => 2,  43 => 1,);
    }
...
{% for message in app.flashes('success') %}
        <div class=\"alert success\" role=\"success\">{{ message }}</div>
    {% endfor %}
<p>
    Please confirm your email address by clicking the following link: <br><br>
